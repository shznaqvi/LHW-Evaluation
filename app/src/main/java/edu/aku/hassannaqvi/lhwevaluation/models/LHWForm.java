...
public class LHWForm extends BaseObservable implements Observable {
    ...
    public LHWForm Hydrate(Cursor cursor) throws JSONException {
        this.id = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_ID));
        this.uid = cursor.getString(cursor.getColumnIndexOrThrow(HHFormsTable.COLUMN_UID));
        this.cluster = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_CLUSTER));
        this.hhid = cursor.getString(cursor.getColumnIndexOrThrow(HHFormsTable.COLUMN_HHID));
        this.userName = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_USERNAME));
        ...
        this.deviceTag = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_DEVICETAGID));
        this.appver = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_APPVERSION));
        this.iStatus = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_ISTATUS));
        this.synced = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_SYNCED));
        this.syncDate = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_SYNCED_DATE));


        sH1Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(HHFormsTable.COLUMN_SH1)));
        sH2Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_SH2)));
        sH3Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_SH3)));
        sABHydrate(cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.HHFormsTable.COLUMN_SAB)));
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(TableContracts.HHFormsTable.COLUMN_ID, this.id);
        json.put(TableContracts.HHFormsTable.COLUMN_UID, this.uid);
        json.put(TableContracts.HHFormsTable.COLUMN_CLUSTER, this.cluster);
        json.put(TableContracts.HHFormsTable.COLUMN_HHID, this.hhid);
        json.put(TableContracts.HHFormsTable.COLUMN_USERNAME, this.userName);
        json.put(TableContracts.HHFormsTable.COLUMN_SYSDATE, this.sysDate);
        json.put(TableContracts.HHFormsTable.COLUMN_DEVICEID, this.deviceId);
        json.put(HHFormsTable.COLUMN_DEVICETAGID, this.deviceTag);
        json.put(TableContracts.HHFormsTable.COLUMN_ISTATUS, this.iStatus);
        //  json.put(HHFormsTable.COLUMN_SYNCED, this.synced);
        //  json.put(HHFormsTable.COLUMN_SYNCED_DATE, this.syncDate);

        // Household

        json.put(TableContracts.HHFormsTable.COLUMN_SH1, new JSONObject(sH1toString()));
        json.put(TableContracts.HHFormsTable.COLUMN_SH2, new JSONObject(sH2toString()));
        json.put(TableContracts.HHFormsTable.COLUMN_SH3, new JSONObject(sH3toString()));
        json.put(TableContracts.HHFormsTable.COLUMN_SAB, new JSONObject(sABtoString()));
        json.put(TableContracts.HHFormsTable.COLUMN_SM, new JSONObject(sMtoString()));
        return json;
    }
