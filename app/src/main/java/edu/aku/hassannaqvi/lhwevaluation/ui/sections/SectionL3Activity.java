...
public class SectionL3Activity extends AppCompatActivity {
    private static final String TAG = "SectionL3Activity";
    ActivitySectionL3Binding bi;
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFormColumn(TableContracts.FormsTable.COLUMN_SC, form.sCtoString());
