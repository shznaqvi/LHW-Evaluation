...
import static edu.aku.hassannaqvi.lhwevaluation.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.lhwevaluation.models.SyncModel;
import edu.aku.hassannaqvi.lhwevaluation.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.lhwevaluation.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.lhwevaluation.workers.PhotoUploadWorker2;
                            ...
                            switch (tableName) {
                                case UsersTable.TABLE_NAME:
                                    try {
                                        ...
                                        downloadTables.get(position).setmessage("JSONException:" + e.getMessage());
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.lhwevaluation.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.lhwevaluation.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.lhwevaluation.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
