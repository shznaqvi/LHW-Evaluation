...
import edu.aku.hassannaqvi.lhwevaluation.databinding.ActivitySectionW3Binding;
...
public class SectionW3Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesMwraColumn(TableContracts.MWRAListTable.COLUMN_SW3, mwra.sW3toString());
