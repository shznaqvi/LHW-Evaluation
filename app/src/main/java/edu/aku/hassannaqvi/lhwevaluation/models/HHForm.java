...
*/
    ...
    public void sABHydrate(String string) throws JSONException {
        ...
        if (string != null) {
            JSONObject json = null;
            json = new JSONObject(string);
            this.adolUID = json.has("adolUID") ? json.getString("adolUID") : "";
            this.adolSno = json.has("adolSno") ? json.getString("adolSno") : "";
            this.adolAge = json.has("adolAge") ? json.getString("adolAge") : "";
    ...
    public void sMHydrate(String string) throws JSONException {
        ...
        if (string != null) {
            JSONObject json = null;
            json = new JSONObject(string);
            this.maleUID = json.has("maleUID") ? json.getString("maleUID") : "";
            this.maleUID = json.has("maleSno") ? json.getString("maleSno") : "";
            this.maleAge = json.has("maleAge") ? json.getString("maleAge") : "";
            this.maritalStatus = json.has("maritalStatus") ? json.getString("maritalStatus") : "";
